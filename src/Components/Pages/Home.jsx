        ...
        <div className="home-container">
          ...
          <div className="home-content animate-left">
            ...
            <p className="home-description">
              <span>Full Stack Software Developer</span> at Sapeagle ERP Pvt Ltd., working across backend (Asp.Net Core, RESTful API, SQL Server and MySQL) and frontend (Reactjs, JavaScript) to build responsive and scalable web applications.
            </p>
